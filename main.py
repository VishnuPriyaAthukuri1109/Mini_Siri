...
from selenium import webdriver                           # Main Selenium WebDriver API
...
newsapi_key="dd89da9852694e6fbd3767a708d365a2"
        ...
        if not command_handled:
            ...
            if 'temperature in' in command:
                ...
                try:
                    ...
                    print("Fetching news...")
                    talk("Here are some of todat's top news headlines:")
                ...
                talk('My favorite c olor is blue.')
                command_handled = True
